                    ...
                    <div
                        ...
                        <div class="relative h-48 bg-gray-200">
                            ...
                            <div class="absolute top-2 right-2">
                                <span
                                    class="px-2 py-1 text-xs font-bold text-white bg-black bg-opacity-50 rounded-full backdrop-blur-sm">
                                    ...
                                    @if($card->seasons->isNotEmpty())
                                        <div class="flex -space-x-1 overflow-hidden">
                                            @foreach($card->seasons as $season)
                                                <span
                                                    class="inline-block px-2 py-0.5 rounded-full bg-indigo-100 text-indigo-800 text-xs mr-1">
                                                    {{ $season->name }}
                                                </span>
                                            @endforeach
                                        </div>
